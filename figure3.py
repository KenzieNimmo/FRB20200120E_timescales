...
plt.text(7e-2,5e11,'FRB 20121102A',color='lightblue')
...
plt.text(6e-8,4e13,'FRB 20180916B (Nimmo et al. 2021a)', color='springgreen')
...
plt.text(9e-8,1e7,'FRB 20200120E\n(Nimmo et al. 2021b)', color='black')
...
plt.savefig('figure3_KN.pdf',format='pdf',dpi=300)
plt.show()
